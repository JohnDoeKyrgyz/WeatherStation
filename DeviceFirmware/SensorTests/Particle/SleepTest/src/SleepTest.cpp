...
#include "Particle.h"
#line 1 "c:/working/WeatherStation/DeviceFirmware/SensorTests/Particle/SleepTest/src/SleepTest.ino"
//SYSTEM_MODE(MANUAL);
//SYSTEM_THREAD(ENABLED);

void setup();
void loop();
#line 4 "c:/working/WeatherStation/DeviceFirmware/SensorTests/Particle/SleepTest/src/SleepTest.ino"
FuelGauge fuel;
void setup()
{
  Serial.begin(115200);
